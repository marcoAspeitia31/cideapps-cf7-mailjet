 ...
 * @subpackage Cideapps_Cf7_Mailjet/public
 */
 ...
 */
class Cideapps_Cf7_Mailjet_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/cideapps-cf7-mailjet-public.css', array(), $this->version, 'all' );
